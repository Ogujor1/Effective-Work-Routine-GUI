...
def reset_timer():
    ...
    title_label.config(text="Timer", font=(FONT_NAME, 50, "bold"), fg=GREEN)
...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        title_label.config(text="Long Break", font=(FONT_NAME, 50, "bold"), fg=RED,)
    elif reps % 2 == 0:
        count_down(short_break_sec)
        title_label.config(text="Short Break", font=(FONT_NAME, 50, "bold"), fg=PINK, )
    else:
        count_down(work_sec)
